...
const UpdateReview = () => {
    ...
    return (
        <div className="mx-auto w-11/12 p-6 bg-[#f0f4f8] dark:bg-[#1e293b]">
            <h2 className="text-2xl font-bold text-center mb-6 ">Update Review: {review.title}</h2>
            <form onSubmit={handleUpdateReview} className="space-y-4">
                ...
                {/* form genre row */}
                <select name="genre"
                defaultValue={review.genre} className="select w-full">
                ...
                {/* button */}
                <input type="submit" value="Update Review" className="btn btn-block bg-gray-300" />
            </form>
        </div>
    );
};
